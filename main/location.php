...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="location.php"><i class="icon-group icon-2x"></i> location</a> </li>
...
<?php
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM location ORDER BY loc_id DESC");
				$result->execute();
				$rowcount = $result->rowcount();
			?>
			<div style="text-align:center;">
			Total Number of location: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
