...
<hr>
<div id="ac">
<span>Product code : </span><input type="text" style="width:265px; height:30px;" value="<?php echo $finalcode; ?>" name="code" ><br>
...
<span>Brand : </span><textarea style="width:265px; height:50px;" name="name"> </textarea><br>
<span>Date Arrival: </span><input type="date" style="width:265px; height:30px;" name="date_arrival" /><br>
<span>Input Date : </span><input type="date" value="<?php echo date ('M-d-Y'); ?>" style="width:265px; height:30px;" name="exdate" /><br>
<span> </span><input type="hidden" id="txt1" style="width:265px; height:30px;" name="price" onkeyup="sum();" ><br>
<span>Price : </span><input type="text" id="txt2" style="width:265px; height:30px;" name="o_price" onkeyup="sum();" Required><br>
