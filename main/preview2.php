...
<div style="margin: 0 auto; padding: 20px; width: 80px; font-weight: normal;">
	<div style="width: 100%; height: 190px;" >
	<div style="width: 900px; float: left;">
    <center><div style="font:bold 25px 'Aleo';">DILANO PHARMACY</div>
    Loc:Premises of Petroland Filling Station,Nkoransa.<br>
    Tel:0244703535/0274703535/0264703535<br>
    Email:dilanopharma23@yahoo.com<br><br>
  	</center>
	<div>
	<?php
 ...
 <table cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:right;width : 100%;">
   ...
   <tr>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<tr>
					<td colspan="5" style=" text-align:right;"><strong style="font-size: 15px;">Total Amount: &nbsp;</strong></td>
				...
				<tr>
					...
					<td colspan="2"><strong style="font-size: 13px; color: #222222;">
					<?php
  ...
  <center><div style="font:bold 25px 'Aleo';"></div>
	Thank you for shopping with us!<br>
	Powered by Ekene Technologies system Limited.	<br>
  Tel:(020) 170-3337 / (054) 249-4320 <br><br>
	</center>
