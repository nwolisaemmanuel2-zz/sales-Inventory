...
function createRandomPassword() {
	$chars = "0032323032320232320123456789";
...
<div class="container-fluid">
  ...
  <?php if(has_permission('admin')):?>
      ...
      <li class="active"><a href="dayreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Daily Sales</a> </li>
			<br><br><br><br><br><br>
			<li>
...
<option></option>
	...
	?>
		...
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Quality: <?php echo $row['qty']; ?> | Price:Gh <?php echo $row['price']; ?></option>
	<?php
				}
			?>
</select>
...
<input type="number" name="discount" value="" placeholder="Discount" autocomplete="off" style="width: 68px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" />
